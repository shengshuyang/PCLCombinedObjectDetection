...
#include <pcl/common/transforms.h>
	...
	void geonDetector::rotate_to_horizon(pcl::PointCloud<PointT>::Ptr output)
	{
		Eigen::Vector3f n(coefficients->values[0],coefficients->values[1],coefficients->values[2]);//normal of the detected plane
		...
		Eigen::Affine3f t3;
		t3 = Eigen::AngleAxisf(-90*PI/180,Eigen::Vector3f::UnitX());
		Eigen::Affine3f t = t3*t2*t1;
		pcl::transformPointCloud(*cloud_filtered,*output,t);
	}
