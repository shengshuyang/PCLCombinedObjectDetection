...
int main(int argc, char *argv[])
{
  ...
  pcl::search::Search<pcl::PointXYZHSV>::Ptr tree =
    boost::shared_ptr<pcl::search::Search<pcl::PointXYZHSV>>( new pcl::search::KdTree<pcl::PointXYZHSV>);
  ...
  std::stringstream ss;
  ss << filename.substr(0,pos-3) << "_segmented.pcd";
  writer.write(ss.str(), *colored_cloud);
